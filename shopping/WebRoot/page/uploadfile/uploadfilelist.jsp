...
<head>
<title>上传文件显示</title>
<meta http-equiv="Content-Type" content="/shopping/text/html; charset=UTF-8">
...
<script language="JavaScript">
	...
	function deleteFiles(objform){
		objform.action='<s:url action="/control/uploadFileAction_delete"/>';
...
<s:form action="uploadFileAction_findAllfile" namespace="/control" method="post">
...
<c:forEach items="${pageView.record}" var="entry">
    <tr>
      <td bgcolor="f5f5f5"> <div align="center"><INPUT TYPE="checkbox" NAME="fileids" value=${entry.fileid}></div></td>
      <td bgcolor="f5f5f5"> <div align="center">${entry.fileid}</div></td>
