...
<s:form action="customerAction_findAllCustomer" namespace="/control" method="post" onsubmit="return checkfm(this)">
<input type="hidden" name="query" value="true">
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <s:textfield name="username" size="30" maxlength="20"/></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <s:textfield name="email" size="50" maxlength="45"/></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
