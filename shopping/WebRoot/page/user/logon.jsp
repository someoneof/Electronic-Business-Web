...
<link href="/shopping/css/global/header.css" rel="stylesheet" type="text/css">
...
<TABLE cellSpacing=0 cellPadding=0 width=770 align=center border=0>
  <TBODY>
  <TR><TD background="/shopping/images/login/login_03.jpg">&nbsp;</TD></TR>
 </TBODY>
</TABLE>
...
<TABLE cellSpacing=1 cellPadding=8 width="600" align="center" bgColor="#dd9988" border=0>
  <TBODY>
  <TR>
    <TD bgColor="#ffffd5" align="left"><IMG height="17" src="/shopping/images/buy/exclamation-error-red.gif" width="17"> <FONT color="#990000"><STRONG><SPAN class="font14">错误提示<BR></SPAN></STRONG></FONT>
...
<s:form action="customerAction_login" namespace="/control"  method="post" onsubmit="javascript:return checkForm()">
			...
			<td align="center"><table width="80%" border="0" align="center" cellpadding="10" cellspacing="0">
					<tr>
						<td width="100%" height="50" valign="top"><table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr>
									<td width="3%"><img src="/shopping/images/global/loginicon1.gif" width="16" height="15" align="absBottom"></td>
					...
					<tr>
						<td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td width="33%" align="left"><a href="${pageContext.request.contextPath }/page/user/findPassword.jsp" class="ablue" target="_blank">忘记密码了？</a></td>
								</tr>
							</table>						</td>
					</tr>
					<tr>
					...
					<tr>
						<td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="8%" align="left" valign="middle"><input type="image" name="ImageButton1" src="/shopping/images/global/regloginbutton2.jpg" alt="" border="0" />&nbsp;</td>
								    <td width="58%" align="left" valign="middle">如果你还未注册，<span style="font-size:14px"><a href="${pageContext.request.contextPath}/page/user/userReg.jsp">请免费注册</a>！</span></td>
								</tr>
							</table>						</td>
					</tr>
				</table>
