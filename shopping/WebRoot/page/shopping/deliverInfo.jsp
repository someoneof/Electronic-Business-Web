...
<link href="/shopping/css/global/address.css" rel="stylesheet" type="text/css">
<link href="/shopping/css/global/bottom.css" rel="stylesheet" type="text/css">
<TITLE>巴巴运动网：结算中心：填写收货地址</TITLE>
<SCRIPT LANGUAGE="JavaScript" src="/shopping/js/Country.js" type="text/javascript"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript" src="/shopping/js/provinceArea.js" type="text/javascript"></SCRIPT>
...
function sendForm(){
	var form = document.forms[0];
	/* form.action="<s:url action="deliverInfoAction_saveDeliverInfo" namespace="/control" />"; */
...
<s:form action="deliverInfoAction_saveDeliverInfo" namespace="/control" method="post">
<INPUT TYPE="hidden" NAME="method" value="saveDeliverInfo">
<TABLE cellSpacing=0 cellPadding=0 align="center" border=0>
  <TBODY>
  <TR>
    <TD><IMG src="/shopping/images/global/logo.gif" >   &nbsp;&nbsp;<IMG height=36 src="/shopping/images/buy/az-s-checkout-shipping-bann.gif" > </TD></TR></TBODY></TABLE><BR>
    ...
    <TD>
      ...
      <TABLE cellSpacing=1 cellPadding=4 width="100%" border=0>
        ...
        <TR>
          ...
          <TD><input type="text" name="receiver" maxlength="30" size="30"/><FONT color="#ff0000">*</FONT>&nbsp;<input type="radio" name="gender" value="MAN"/>先生 <input type="radio" name="gender" value="WOMEN"/>女士</TD></TR>
        <TR>
          <TD height="27">
...
<font color="#484848">（手机和电话至少有一项必填）</font></TD></TR>
        ...
        <TR id="buyerinfoInput" style="DISPLAY: none">
		  ...
		  <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
            <TR>
              ...
              <TD align="left"><input type="text" name="buyer" maxlength="30" size="30" />
              &nbsp;<input type="radio" name="buyer_gender" value="MAN" />先生 <input type="radio" name="buyer_gender" value="WOWEN"/>女士</TD>
            </TR>
            <TR>
        ...
        <TR>
          ...
          <input type="submit" value="下一步" onClick="javascript:sendForm()" /></input>
          <!-- <IMG onClick="javascript:sendForm()" src="/shopping/images/buy/az-sfl-shipping-to-this-boo.gif" vspace=5 border=0 style="CURSOR: hand;"> -->
          <!-- <img src="/shopping/images/buy/az-sfl-shipping-to-this-boo.gif" vspace=5 border=0 style="CURSOR: hand; onClick="javascript:sendForm()"></td> -->
          </TD></TR>
		  </TBODY></TABLE></DIV>
      </TD></TR></TBODY></TABLE>
</s:form>
