...
<link href="/shopping/css/global/paymentway.css" rel="stylesheet" type="text/css">
...
<TABLE cellSpacing=0 cellPadding=0 align=center border=0>
  <TBODY>
  <TR>
    <TD><IMG src="/shopping/images/global/logo.gif" > 
	&nbsp;&nbsp;<IMG height=36 src="/shopping/images/buy/az-s-checkout-payment-banne.gif" > 
	</TD>
  </TR>
  </TBODY>
</TABLE>
<BR>
<s:form action="customerManager_orderConfirm"  namespace="control" method="post">
...
<SPAN class=h1><STRONG>请选择您的送货与支付方式:</STRONG></SPAN> 
      <TABLE height=31 cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD>
            <DIV align=right><IMG onClick="javascript:sendForm()" height="22" src="/shopping/images/buy/az-sfl-shipping-to-this-boo.gif" vspace=5 border=0 style="CURSOR: hand;">
        </DIV></TD></TR>
	 </TBODY></TABLE>
<A name="deliverway"></A>
