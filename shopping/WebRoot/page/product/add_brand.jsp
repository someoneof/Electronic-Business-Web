...
<s:form action="brandAction_add" namespace="/control" method="post" enctype="multipart/form-data" onsubmit="return checkfm(this)">
<input type="hidden" name="method" value="add">
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
	...
	<tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <s:file  name="logofile" size="50"/>
      </td>
    </tr>
    <tr bgcolor="f5f5f5"> 
