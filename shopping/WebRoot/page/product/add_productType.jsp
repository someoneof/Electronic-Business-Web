...
function checkfm(form){
	...
	if (byteLength(form.note.value)>100){
		alert("备注不能大于100字！");
		form.note.focus();
		return false;
	}	
	else if(trim(form.note.value)=="")
	{
		alert("备注不能为空!");
		form.note.focus();
		return false;
...
<s:form action="productTypeAction_add"   namespace="/control"  method="post" onsubmit="return checkfm(this)">
...
<br>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <s:textfield name="name" size="50" maxlength="50"/><font color="#FF0000">*</font></td>
    </tr>
	<tr bgcolor="f5f5f5"> 
