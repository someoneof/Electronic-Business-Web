...
<s:form action="productAction_editProduct" namespace="/control" enctype="multipart/form-data" method="post">
		...
		<table width="98%" border="0" cellspacing="1" cellpadding="3" align="center">
				...
				<tr bgcolor="f5f5f5">
					...
					<td width="75%">
						...
						(<a href="<s:url action="brandAction_addUI_edit" namespace="/control" />?productid=${productid}">添加品牌</a>)
					</td>
				</tr>
				<tr bgcolor="f5f5f5">
