...
<link href="/shopping/css/css.css" rel="stylesheet" type="text/css">
<!--<base target="main"> -->
<style type="text/css">
<!--
...
<s:form action="employeeManagerAction_login"  namespace="control" method="post">
              ...
              <TR>
                <TD vAlign=top width="360" height="104">
                    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td colspan="2"><img src="/shopping/images/admin/Admin_Login1.gif" width="600" height="126"></td>
                      </tr>
                      <tr>
                        <td width="508" valign="top" background="/shopping/images/admin/Admin_Login2.gif"><table width="508" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                        ...
                        <td><input type="image" name="submit" src="/shopping/images/admin/Admin_Login3.gif" style="width:92px; HEIGHT: 126px;"></td>
                      </tr>
                    </table>
                </TD>
              </TR>
