...
<s:form action="privilegeGroupAction_add" namespace="/control" method="post" onsubmit="return checkfm(this)">
<input type="hidden" name="method" value="add">
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
     ...
     <input type="checkbox" name="privileges" value="${privilege.id.moduel},${privilege.id.value}">
